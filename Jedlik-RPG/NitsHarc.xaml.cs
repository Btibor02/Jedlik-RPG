...
namespace NitsH
{
    public partial class NitsHarc : Window
    {
        ...
        public NitsHarc()
        {
            ...
            helyiEllenfélNév = "Nits";
            EllenfélNévLabel.Content = $"{helyiEllenfélNév}";
            helyiEllenfélHP = 500;
            helyiEllenfélDMG = 20;
            helyiEllenfélMaxHP = 500;
            helyiEllenfélSpell1Név = "Székkel lábra gurulás";
            helyiEllenfélSpell1MinDMG = 20;
            helyiEllenfélSpell1MaxDMG = 35;
            helyiEllenfélSpell1Effekt = "semmi";
            helyiEllenfélSpell2Név = "Papíron programoztatás";
            helyiEllenfélSpell2MinDMG = 30;
            helyiEllenfélSpell2MaxDMG = 40;
            helyiEllenfélSpell2Effekt = "Undorító";
            helyiEllenfélSpell3Név = "Csavarkulccsal dobás";
            helyiEllenfélSpell3MinDMG = 20;
            helyiEllenfélSpell3MaxDMG = 35;
            helyiEllenfélSpell3Effekt = "Vérzés";
            HPváltozott();
        ...
        private async void Win()
        {
            ...
            történésLabel.Content = "Beírtál magadnak egy 5öst amitől megnőtt a büszkeséged és a sebzésed";
            otos.Visibility = Visibility.Visible;
