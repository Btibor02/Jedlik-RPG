...
namespace PetiH
{
    public partial class PetiHarc : Window
    {
        ...
        public PetiHarc()
        {
            ...
            helyiEllenfélNév = "Peti néni";
            EllenfélNévLabel.Content = $"{helyiEllenfélNév}";
            helyiEllenfélHP = 500;
            helyiEllenfélDMG = 20;
            helyiEllenfélMaxHP = 500;
            helyiEllenfélSpell1Név = "Irodalom könyvvel ütés";
            helyiEllenfélSpell1MinDMG = 30;
            helyiEllenfélSpell1MaxDMG = 35;
            helyiEllenfélSpell1Effekt = "semmi";
            helyiEllenfélSpell2Név = "Rappelés";
            helyiEllenfélSpell2MinDMG = 19;
            helyiEllenfélSpell2MaxDMG = 23;
            helyiEllenfélSpell2Effekt = "Fagyás";
            helyiEllenfélSpell3Név = "Feleltetés";
            helyiEllenfélSpell3MinDMG = 32;
            ...
            if (melyikSpell == 3)
            {
                ...
                else
                {
                    ...
                    if (helyiEllenfélSpell3Effekt == "Tűz")
                    {
                        ...
                        {
                            helyiKarakterTűz = 3;
                            történésLabel.Content = $"{AlapAdatok.aktKarakterNév} beszar-t!";
                        }
        ...
        private async void KarakterJön()
        {
            ...
            if (helyiKarakterTűz > 0 || helyiKarakterVérzés > 0 || helyiKarakterUndorító > 0 || helyiKarakterFagyás > 0)
            {
                ...
                {
                    int dmg = rnd.Next(5, 11);
                    történésLabel.Content = $"{AlapAdatok.aktKarakterNév} be van szarva ezért {dmg}-t sebződött";
                    helyiKarakterTűz -= 1;
                    helyiKarakterHP -= dmg;
                    HPváltozott();
                    await Task.Delay(2000);
        ...
        private async void Win()
        {
            ...
            történésLabel.Content = "Diadalittasan továbbmész a folyosón";
