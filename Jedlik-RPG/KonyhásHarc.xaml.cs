...
namespace KonyhásH
{
    public partial class KonyhásHarc : Window
    {
        ...
        public KonyhásHarc()
        {
            ...
            helyiEllenfélNév = "Konyhás néni";
            EllenfélNévLabel.Content = $"{helyiEllenfélNév}";
            helyiEllenfélHP = 450;
            helyiEllenfélDMG = 15;
            helyiEllenfélMaxHP = 450;
            helyiEllenfélSpell1Név = "Forró spatula";
            helyiEllenfélSpell1MinDMG = 25;
            helyiEllenfélSpell1MaxDMG = 30;
            helyiEllenfélSpell1Effekt = "semmi";
            helyiEllenfélSpell2Név = "Moslék";
            helyiEllenfélSpell2MinDMG = 20;
            helyiEllenfélSpell2MaxDMG = 30;
            helyiEllenfélSpell2Effekt = "Tűz";
            helyiEllenfélSpell3Név = "Levesbe köpés";
            helyiEllenfélSpell3MinDMG = 2;
            helyiEllenfélSpell3MaxDMG = 5;
            helyiEllenfélSpell3Effekt = "Undorító";
            HPváltozott();
        ...
        private async void EllenfélTámad()
        {
            ...
            if (használt == 2)
            {
                melyikSpell = rnd.Next(1, 3);
            }
            else
            {
                melyikSpell = rnd.Next(1, 4);
            }
            if (melyikSpell == 1)
            {
            ...
            if (melyikSpell == 2)
            {
                ...
                else
                {
                    ...
                    {
                        int tűz = rnd.Next(1, 3);
                        if (tűz == 2)
                        {
                            helyiKarakterTűz = 2;
                            történésLabel.Content = $"{AlapAdatok.aktKarakterNév} valami rosszra harapott és vérezni kezdett!";
                        }
            ...
            if (melyikSpell == 3)
            {
                ...
                else
                {
                    ...
                    HPváltozott();
                    await Task.Delay(2000);
                    történésLabel.Content = $"{AlapAdatok.aktKarakterNév} elgyengült a köpéstől, ezért sebzése 3-al csökkent";
                    helyiKarakterDMG -= 3;
                    await Task.Delay(2000);
                    történésLabel.Content = "";
        ...
        private async void Win()
        {
            ...
            történésLabel.Content = "A konyhán találtál kaját amitől az életerőd 100-al nőtt";
            kaja.Visibility = Visibility.Visible;
