...
namespace RempiH
{
    public partial class RempiHarc : Window
    {
        ...
        public RempiHarc()
        {
            ...
            helyiEllenfélNév = "Rempi";
            EllenfélNévLabel.Content = $"{helyiEllenfélNév}";
            helyiEllenfélHP = 700;
            helyiEllenfélDMG = 20;
            // helyiEllenfélDMG = 300;
            helyiEllenfélMaxHP = 700;
            helyiEllenfélSpell1Név = "Szakáll csapás";
            helyiEllenfélSpell1MinDMG = 30;
            helyiEllenfélSpell1MaxDMG = 40;
            helyiEllenfélSpell1Effekt = "semmi";
            helyiEllenfélSpell2Név = "Macska barát";
            helyiEllenfélSpell2MinDMG = 10;
            helyiEllenfélSpell2MaxDMG = 15;
            helyiEllenfélSpell2Effekt = "Vérzés";
            helyiEllenfélSpell3Név = "Lézerkard dobás";
            helyiEllenfélSpell3MinDMG = 5;
            helyiEllenfélSpell3MaxDMG = 10;
            helyiEllenfélSpell3Effekt = "Tűz";
            HPváltozott();
        ...
        public void HPváltozott()
        {
            ...
            //    történésLabel.Content = "Vesztettél te szar!";
            ...
            //    Spell3Gomb.IsEnabled = false;
            //    await Task.Delay(2000);
            //    történésLabel.Content = "Nyertél te szar!";
            //    await Task.Delay(2000);
            //    történésLabel.Visibility = Visibility.Hidden;
            //    Win();
