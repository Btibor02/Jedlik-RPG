...
namespace Módi
{
    public partial class MódosHarc : Window
    {
        ...
        public MódosHarc()
        {
            ...
            helyiEllenfélNév = "Módos";
            EllenfélNévLabel.Content = $"{helyiEllenfélNév}";
            helyiEllenfélHP = 500;
            helyiEllenfélDMG = 20;
            helyiEllenfélMaxHP = 500;
            helyiEllenfélSpell1Név = "Kamu beírás";
            helyiEllenfélSpell1MinDMG = 20;
            helyiEllenfélSpell1MaxDMG = 35;
            helyiEllenfélSpell1Effekt = "semmi";
            helyiEllenfélSpell2Név = "Nyakkendő igazítás";
            helyiEllenfélSpell2MinDMG = 30;
            helyiEllenfélSpell2MaxDMG = 40;
            helyiEllenfélSpell2Effekt = "Heal";
            helyiEllenfélSpell3Név = "Családi pótlék megvonása";
            helyiEllenfélSpell3MinDMG = 100;
            helyiEllenfélSpell3MaxDMG = 130;
            helyiEllenfélSpell3Effekt = "semmi";
            HPváltozott();
        ...
        private async void Win()
        {
            ...
            történésLabel.Foreground = Brushes.Black;
            történésLabel.Content = "Módos zsebében megtaláltad a 110 kulcsát";
